...
<body>
    <div class="container">
        <h1 style="color: #FFFFFF; font-family:'Roboto'">KuyJalan!</h1><br><br>
        ...
        <form action="edit1.php" method="post" name="form1">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_tempat" name="nama_tempat" value=<?php echo $Nama_tempat; ?>>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary" name="update" onclick="alert('Data berhasil diperbaharui')">Perbaharui</button>
        </form>
</body>
